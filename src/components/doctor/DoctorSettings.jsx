      ...
      <div className="content" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "30px" }}>
        <div className="box" style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px", borderBottom: "1.5px solid var(--bg-main)", paddingBottom: "20px" }}>
            <div style={{ position: "relative" }}>
              ...
              <span
                style={{ position: "absolute", bottom: "0", right: "0", background: "var(--accent-emerald)", width: "16px", height: "16px", borderRadius: "50%", border: "3.5px solid white" }}
                title="نشط"
              ></span>
            </div>
            <div>
          ...
          <button
            className="btn"
            onClick={() => {
              setTempDoctorInfo({ ...doctorInfo });
              setEditDoctorModalOpen(true);
            }}
            style={{ alignSelf: "flex-start", marginTop: "10px", fontWeight: "bold", display: "flex", alignItems: "center", gap: "8px" }}
          >
        ...
        <div className="box" style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", borderTop: "1.5px solid var(--bg-main)", paddingTop: "15px", fontSize: "14px" }}>
            <div><b>آخر تسجيل دخول:</b> <span style={{ fontFamily: "Outfit", color: "var(--text-dark)" }}>اليوم الساعة 08:30 صباحًا</span></div>
          ...
          <div style={{ display: "flex", gap: "10px", marginTop: "10px", flexWrap: "wrap" }}>
            <button
              ...
              onClick={() => showToast("تم إرسال رابط إعادة تعيين كلمة المرور لبريدك الإلكتروني المعتمد", "info")}
            ...
            <button
              ...
              style={{ fontSize: "12px", fontWeight: "bold", background: "rgba(239, 68, 68, 0.1)", color: "var(--accent-red)", border: "1px solid rgba(239, 68, 68, 0.2)" }}
            >
        ...
        <div className="box" style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--border-color)", paddingBottom: "8px", gap: "16px" }}>
        ...
        <div className="box" style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "16px" }}>
              <div>
                <span style={{ fontWeight: "600", display: "block" }}>حجم الخط</span>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "16px" }}>
              <div>
                <span style={{ fontWeight: "600", display: "block" }}>لغة الواجهة الحالية</span>
                <small style={{ color: "var(--text-muted)" }}>تم اعتماد العربية فقط داخل الإعدادات</small>
              </div>
              <span style={{ padding: "8px 12px", borderRadius: "var(--radius-sm)", border: "1.5px solid var(--border-color)", fontSize: "13px", fontWeight: "700", background: "white", color: "var(--text-dark)" }}>
                العربية
              </span>
            </div>
          </div>
        ...
        <div className="box" style={{ display: "flex", flexDirection: "column", gap: "18px", background: "linear-gradient(135deg, var(--bg-card) 0%, rgba(11, 61, 145, 0.03) 100%)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", borderTop: "1.5px solid var(--bg-main)", paddingTop: "15px", fontSize: "13px" }}>
            <div><b>رقم الإصدار:</b> <span style={{ fontFamily: "Outfit", color: "var(--text-dark)" }}>1.0.0</span></div>
